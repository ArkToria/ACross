...
void
LogTools::init(std::shared_ptr<spdlog::details::thread_pool> thread_pool)
{
...
void
LogTools::setLoggerName(const std::string& name)
{
  m_name = name;
}

void
LogTools::setFileName(const std::string& name)
{
  m_filename = name;
}

void
LogTools::setPath(const std::string& path)
{
  m_path = path;
}

void
LogTools::setLogMode(LogMode mode)
{
  m_mode = mode;
}

void
LogTools::setMaxKeepFile(int num)
{
  m_max_keep_file = num;
}

void
LogTools::setMaxLogSize(int size)
{
  m_max_log_size = size;
}
