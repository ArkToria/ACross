...
bool JsonTools::setData(const std::string& data_str)
{
    m_data = data_str;
...
bool JsonTools::setDataStream(const std::stringstream& data_stream)
{
...
Json::Value JsonTools::getRoot()
{
    return m_root;
}

bool JsonTools::jsonParse(const std::string& raw_json, Json::Value& result, Json::String& err_msg)
{
    ...
    bool err = reader->parse(raw_json.c_str(), raw_json.c_str() + rawJsonLength, &result, &err_msg);

    return err;
}

Json::Value SIP008::toObject(int index)
{
    Json::Value root;
...
Json::Value HttpObject::AccountObject::toObject()
{
    Json::Value root;
...
void HttpObject::InboundSettingObject::appendAccountObject(AccountObject account)
{
    this->accounts.append(account.toObject());
}

void HttpObject::InboundSettingObject::appendAccountObject(Json::Value account)
{
    this->accounts.append(account);
}

Json::Value HttpObject::InboundSettingObject::toObject()
{
    Json::Value root;
...
void HttpObject::OutboundSettingObject::appendUserObject(AccountObject user)
{
    this->users.append(user.toObject());
}

void HttpObject::OutboundSettingObject::appendUserObject(Json::Value user)
{
    this->users.append(user);
}

Json::Value HttpObject::OutboundSettingObject::toObject()
{
    Json::Value root;
...
Json::Value SocksObject::AccountObject::toObject()
{
    Json::Value root;
...
void SocksObject::InboundSettingObject::appendAccountObject(AccountObject account)
{
    this->accounts.append(account.toObject());
    this->auth = "password";
}

void SocksObject::InboundSettingObject::appendAccountObject(Json::Value account)
{
    this->accounts.append(account);
    this->auth = "password";
}

Json::Value SocksObject::InboundSettingObject::toObject()
{
    Json::Value root;
...
void SocksObject::OutboundSettingObject::appendUserObject(AccountObject user)
{
    this->users.append(user.toObject());
}

void SocksObject::OutboundSettingObject::appendUserObject(Json::Value user)
{
    this->users.append(user);
}

Json::Value SocksObject::OutboundSettingObject::toObject()
{
    Json::Value root;
...
bool ShadowsocksObject::checkMethod(const std::string& method)
{
...
bool ShadowsocksObject::InboundSettingObject::setNetwork(const std::string& type)
{
...
bool ShadowsocksObject::InboundSettingObject::setMethod(const std::string& method)
{
...
Json::Value ShadowsocksObject::InboundSettingObject::toObject()
{
    Json::Value root;
...
bool ShadowsocksObject::OutboundSettingObject::setMethod(const std::string& method)
{
    bool result = checkMethod(method);
...
bool ShadowsocksObject::OutboundSettingObject::fromSIP008Server(const SIP008::Server& server)
{
...
Json::Value ShadowsocksObject::OutboundSettingObject::toObject()
{
    Json::Value root;
...
Json::Value VMessObject::ClientObject::toObject()
{
    Json::Value root;
...
Json::Value VMessObject::DefaultObject::toObject()
{
    Json::Value root;
...
Json::Value VMessObject::DetourObject::toObject()
{
    Json::Value root;
...
void VMessObject::InboundSettingObject::appendClientObject(Json::Value client)
{
    this->client_objects.append(client);
}

void VMessObject::InboundSettingObject::appendClientObject(ClientObject client)
{
    this->client_objects.append(client.toObject());
}

Json::Value VMessObject::InboundSettingObject::toObject()
{
    Json::Value root;
...
bool VMessObject::UserObject::setMethod(const std::string& method)
{
    const std::list<std::string> methods = {
        "aes-128-gcm",
        "chacha20-poly1305",
...
Json::Value VMessObject::UserObject::toObject()
{
    Json::Value root;
...
void VMessObject::OutboundSettingObject::appendUserObject(Json::Value user)
{
    this->user_objects.append(user);
}

void VMessObject::OutboundSettingObject::appendUserObject(UserObject user)
{
    this->user_objects.append(user.toObject());
}

Json::Value VMessObject::OutboundSettingObject::toObject()
{
    Json::Value root;
...
bool SniffingObject::appendDestOverride(const std::string& type)
{
    const std::list<std::string> types = {
        "http",
        "tls",
...
Json::Value SniffingObject::toObject()
{
    Json::Value root;
...
bool AllocateObject::setStrategy(const std::string& type)
{
...
bool AllocateObject::setRefresh(uint min)
{
...
bool AllocateObject::setConcurrency(uint num, std::string port_info)
{
    bool result = false;
    ...
    do {
        ...
        if (found_range != std::string::npos) {
            ...
            port_range.second = std::stoi(port_info.substr(found_range + 1, port_info.size()));

            if (port_range.second - port_range.first > 0
                    && num < (port_range.second - port_range.first) / 3
                    && num >= 1) {
...
Json::Value AllocateObject::toObject()
{
    Json::Value root;
...
AllocateObject InboundObject::createAllocateObject(const std::string& strategy, int refresh, uint concurrency)
{
...
void InboundObject::setSniffingObject(Json::Value sniffing_object)
{
    this->sniffing = sniffing_object;
}

void InboundObject::setSniffingObject(SniffingObject sniffing_object)
{
    this->sniffing = sniffing_object.toObject();
}

void InboundObject::setAllocate(const std::string& strategy, int refresh, uint concurrency)
{
...
void InboundObject::setAllocateObject(Json::Value allocate_object)
{
    this->allocate = allocate_object;
}

void InboundObject::setAllocateObject(AllocateObject allocate_object)
{
    this->allocate = allocate_object.toObject();
}

Json::Value InboundObject::toObject()
{
    Json::Value root;
...
void InboundObjects::appendInboundObject(Json::Value inbound_object)
{
    this->inbounds.append(inbound_object);
}

void InboundObjects::appendInboundObject(InboundObject inbound_object)
{
    this->inbounds.append(inbound_object.toObject());
}

void InboundObjects::setObject(Json::Value& root)
{
    root["inbounds"] = this->inbounds;
}

Json::Value ProxySettingsObject::toObject()
{
    Json::Value root;
...
Json::Value MuxObject::toObject()
{
    Json::Value root;

    root["enabled"] = this->enabled;

    if (this->concurrency == -1 || (this->concurrency >= 1 && this->concurrency <= 1024)) {
        root["concurrency"] = this->concurrency;
    } else {
...
void OutboundObject::setProxySettingsObject(Json::Value proxy_settings_object)
{
    this->proxy_settings = proxy_settings_object;
}

void OutboundObject::setProxySettingsObject(ProxySettingsObject proxy_settings_object)
{
    this->proxy_settings = proxy_settings_object.toObject();
}

void OutboundObject::setMuxObject(Json::Value mux_object)
{
    this->mux = mux_object;
}

void OutboundObject::setMuxObject(MuxObject mux_object)
{
    this->mux = mux_object.toObject();
}

void OutboundObject::appendShadowsocksObject(ShadowsocksObject::OutboundSettingObject& shadowsocks_object)
{
...
void OutboundObject::appendTrojanObject(TrojanObject::OutboundSettingObject& trojan_object)
{
...
void OutboundObject::appendVMessObject(VMessObject::OutboundSettingObject &vmess_object)
{
    this->protocol = "vmess";
...
void OutboundObject::setTransportStreamObject(TransportObject::OutboundStreamObject& trojan_stream_object)
{
    this->stream_settings = trojan_stream_object.toObject();
}

Json::Value OutboundObject::toObject()
{
    Json::Value root;
...
void OutboundObjects::appendOutboundObject(Json::Value outbound_object)
{
    this->outbounds.append(outbound_object);
}

void OutboundObjects::appendOutboundObject(OutboundObject outbound_object)
{
    this->outbounds.append(outbound_object.toObject());
}

void OutboundObjects::setObject(Json::Value& root)
{
    root["outbounds"] = this->outbounds;
}

Json::Value TrojanObject::ClientObject::toObject()
{
    Json::Value root;
...
Json::Value TrojanObject::FallbackObject::toObject()
{
    Json::Value root;
...
void TrojanObject::InboundSettingObject::appendClientObject(Json::Value client)
{
    this->client_objects.append(client);
}

void TrojanObject::InboundSettingObject::appendClientObject(ClientObject client)
{
    this->client_objects.append(client.toObject());
}

void TrojanObject::InboundSettingObject::appendFallbackObject(Json::Value fallback)
{
    this->fallback_objects.append(fallback);
}

void TrojanObject::InboundSettingObject::appendFallbackObject(FallbackObject fallback)
{
    this->fallback_objects.append(fallback.toObject());
}

Json::Value TrojanObject::InboundSettingObject::toObject()
{
    Json::Value root;
...
Json::Value TrojanObject::OutboundSettingObject::toObject()
{
    Json::Value root;
...
void TransportObject::TLSObject::appendAlpn(const std::string& value)
{
    if (!value.empty()) {
...
void TransportObject::TLSObject::appendCertificateObject(Json::Value certificate)
{
    this->certificate_objects.append(certificate);
}

void TransportObject::TLSObject::appendCertificateObject(CertificateObject certificate)
{
    this->certificate_objects.append(certificate.toObject());
}

Json::Value TransportObject::TLSObject::toObject()
{
    Json::Value root;
...
void TransportObject::CertificateObject::appendCertificate(const std::string& value)
{
    if (!value.empty()) {
...
void TransportObject::CertificateObject::appendKey(const std::string& value)
{
    if (!value.empty()) {
...
Json::Value TransportObject::CertificateObject::toObject()
{
    Json::Value root;
    ...
    if (!this->certificate_objects.isNull() && !this->certificate_objects.empty()) {
...
void TransportObject::OutboundStreamObject::setTLSSetting(Json::Value tls_object)
{
    this->tls_setting = tls_object;
}

void TransportObject::OutboundStreamObject::setTLSSetting(TLSObject tls_object)
{
    this->tls_setting = tls_object.toObject();
}

void TransportObject::OutboundStreamObject::setWebsocketSetting(Json::Value websocket_object)
{
    this->websocket_setting = websocket_object;
}

void TransportObject::OutboundStreamObject::setWebsocketSetting(WebSocketObject websocket_object)
{
    this->websocket_setting = websocket_object.toObject();
}

Json::Value TransportObject::OutboundStreamObject::toObject()
{
    Json::Value root;
...
void TransportObject::WebSocketObject::setHost(const std::string &value)
{
    if (value.empty()) {
        return;
    }
...
Json::Value TransportObject::WebSocketObject::toObject()
{
    Json::Value root;
