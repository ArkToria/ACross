...
class VMessFormModel : public QObject
{
  Q_OBJECT
  Q_PROPERTY(
    QString alterID READ alterID WRITE setAlterID NOTIFY alterIDChanged)
  Q_PROPERTY(
    QString security READ security WRITE setSecutiry NOTIFY secutiryChanged)
  Q_PROPERTY(
    QString network READ network WRITE setNetwork NOTIFY networkChanged)
  Q_PROPERTY(QString host READ host WRITE setHost NOTIFY hostChanged)
  Q_PROPERTY(QString path READ path WRITE setPath NOTIFY pathChanged)
  Q_PROPERTY(
    bool tlsEnable READ tlsEnable WRITE setTlsEnable NOTIFY tlsEnableChanged)
public:
