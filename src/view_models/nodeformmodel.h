...
class NodeFormModel : public QObject {
    ...
    Q_PROPERTY(VMessFormModel* vmess READ vmess WRITE setVmess NOTIFY vmessChanged)
    Q_PROPERTY(TrojanFormModel* trojan READ trojan WRITE setTrojan NOTIFY trojanChanged)
    Q_PROPERTY(ShadowsocksFormModel* shadowsocks READ shadowsocks WRITE setShadowsocks NOTIFY shadowsocksChanged)
    Q_PROPERTY(RawOutboundFormModel* raw READ raw WRITE setRaw NOTIFY rawChanged)
    Q_PROPERTY(URLSchemeFormModel* urlScheme READ urlScheme WRITE setURLScheme NOTIFY urlSchemeChanged)
